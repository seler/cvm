...
from .views import home, IdentityUpdateView, IdentityCreateView, ShareCreateView, ShareUpdateView, IdentityDeleteView, ShareDeleteView, resume_edit, ResumeDeleteView
...
urlpatterns = patterns('',
    ...
    url(r'^resume/(?P<object_id>[0-9]+)/$', resume_edit, name='panel_resume_update'),
